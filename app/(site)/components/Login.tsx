...
//   return (
//     <>
//     <button onClick={() => setOpenModal(true)} className='hidden lg:block'>
//         <svg className='hover:text-[#dd3327] duration-200 transition-colors' width="17" height="17" viewBox="0 0 17 17" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
